...
const MESSAGES = {
  ...
  en: {
    ...
    "扩展本地数据升级失败，请让 Agent 更新或修复扩展。": "The extension could not upgrade its local data. Ask your Agent to update or repair the extension.",
    "扩展本地数据版本记录无效。请让 Agent 运行 extension repair，现有数据不会被清除。": "The extension local-data version record is invalid. Ask your Agent to run extension repair. Existing data will not be cleared.",
    "当前扩展版本低于本机数据版本。请先更新扩展，现有数据不会被降级或清除。": "This extension is older than the local-data version. Update the extension first. Existing data will not be downgraded or cleared.",
    "断开": "Disconnect",
  ...
  ja: {
    ...
    "扩展本地数据升级失败，请让 Agent 更新或修复扩展。": "拡張機能のローカルデータを更新できませんでした。Agent に拡張機能の更新または修復を依頼してください。",
    "扩展本地数据版本记录无效。请让 Agent 运行 extension repair，现有数据不会被清除。": "拡張機能のローカルデータのバージョン記録が無効です。Agent に extension repair の実行を依頼してください。既存データは消去されません。",
    "当前扩展版本低于本机数据版本。请先更新扩展，现有数据不会被降级或清除。": "現在の拡張機能はローカルデータのバージョンより古いため、先に更新してください。既存データはダウングレードも消去もされません。",
    "断开": "切断",
  ...
  ko: {
    ...
    "扩展本地数据升级失败，请让 Agent 更新或修复扩展。": "확장 프로그램의 로컬 데이터를 업그레이드하지 못했습니다. Agent에게 확장 프로그램 업데이트 또는 복구를 요청하세요.",
    "扩展本地数据版本记录无效。请让 Agent 运行 extension repair，现有数据不会被清除。": "확장 프로그램의 로컬 데이터 버전 기록이 올바르지 않습니다. Agent에게 extension repair 실행을 요청하세요. 기존 데이터는 삭제되지 않습니다.",
    "当前扩展版本低于本机数据版本。请先更新扩展，现有数据不会被降级或清除。": "현재 확장 프로그램이 로컬 데이터 버전보다 오래되었습니다. 먼저 확장 프로그램을 업데이트하세요. 기존 데이터는 다운그레이드되거나 삭제되지 않습니다.",
    "断开": "연결 해제",
